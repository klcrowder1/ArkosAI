...
from arkos.app import ArkosApp
from arkos.config import ArkosConfig
from arkos.log import setup_logging
from arkos.util.config import find_config_file
...
def main() -> None:
    ...
    threading.current_thread().name = "arkos"
    ...
    try:
        config = ArkosConfig.load(install=True)
    except ValidationError as e:
        print("*************************************************************")
        print("*************************************************************")
        print("***    Your config file is not valid!                     ***")
        print("***    Please check the docs at                           ***")
        print("***    https://docs.arkos.ai/configuration/               ***")
        print("*************************************************************")
        print("*************************************************************")
