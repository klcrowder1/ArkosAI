...
from arkos.config import CameraConfig, ArkosConfig, RetainModeEnum
from arkos.const import CACHE_DIR, CLIPS_DIR, MAX_WAL_SIZE, RECORD_DIR
from arkos.models import Previews, Recordings, ReviewSegment, UserReviewStatus
from arkos.record.util import remove_empty_directories, sync_recordings
from arkos.util.builtin import clear_and_unlink, get_tomorrow_at_time
...
class RecordingCleanup(threading.Thread):
    ...
    def __init__(self, config: ArkosConfig, stop_event: MpEvent) -> None:
