...
class DetectorRegistry:
    ...
    _instance = None
    _detectors: Dict[str, Type[DetectorInterface]] = {}
    _initialized = False
    ...
    @classmethod
    def register(cls, detector_type: str, detector_class: Type[DetectorInterface]) -> None:
        """
        ...
        """
        if not issubclass(detector_class, DetectorInterface):
            raise TypeError(f"Detector class must inherit from DetectorInterface: {detector_class.__name__}")
    ...
    @classmethod
    def get_detector_class(cls, detector_type: str) -> Optional[Type[DetectorInterface]]:
        """
    ...
    @classmethod
    def create_detector(cls, detector_config: BaseDetectorConfig, **kwargs) -> DetectorInterface:
        """
    ...
    def discover_detectors(cls, package_path: str = None) -> None:
        ...
        if package_path is None:
            ...
            from frigate.detectors import plugins
            ...
            try:
                ...
                for name, obj in inspect.getmembers(module):
                    if (inspect.isclass(obj) and 
                        issubclass(obj, DetectorInterface) and 
                        obj != DetectorInterface):
